...
let ChatComponent = class ChatComponent {
    ...
    // }
    add(messageBody) {
        const newMessage = new _models_message__WEBPACK_IMPORTED_MODULE_2__["Message"](this.message_id, messageBody, this.project_id, localStorage.getItem('username'));
...
CreatemComponent.ctorParameters = () => [
    { type: _services_createm_service__WEBPACK_IMPORTED_MODULE_3__["CreatemService"] },
...
let CreatepComponent = class CreatepComponent {
    ...
    add(pname, description) {
        const newProject = new _models_project__WEBPACK_IMPORTED_MODULE_2__["Project"](this.id, pname, description);
...
CreatepComponent.ctorParameters = () => [
...
let LoginComponent = class LoginComponent {
    ...
    login(username, password) {
        const newloginUser = new _models_loginUser__WEBPACK_IMPORTED_MODULE_2__["loginUser"](username, password);
...
function mapMaterialModules() {
    return Object.keys(_angular_material__WEBPACK_IMPORTED_MODULE_2__).filter((k) => {
        let asset = _angular_material__WEBPACK_IMPORTED_MODULE_2__[k];
        return typeof asset == 'function'
            && asset.name.startsWith('Mat')
            && asset.name.includes('Module');
    }).map((k) => _angular_material__WEBPACK_IMPORTED_MODULE_2__[k]);
}
...
let RegisterComponent = class RegisterComponent {
    ...
    add(username, password, firstName, lastName, email, dateOfBirth) {
        const newUser = new _models_user__WEBPACK_IMPORTED_MODULE_2__["User"](username, password, firstName, lastName, email, dateOfBirth);
...
ViewmemberService.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClient"] }
];
...
ViewaccComponent.ctorParameters = () => [
